...
commands = [
    ...
    "kubectl delete helmchart portainer -n kube-system || true",
    "kubectl delete pods -n kube-system -l job-name=helm-install-portainer || true",
    "echo '=== DEPLOYING PORTAINER VIA YAML ==='",
