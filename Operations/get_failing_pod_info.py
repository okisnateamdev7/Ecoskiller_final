...
commands = [
    "echo '=== PORTAINER POD JSON STATUS ==='",
    "kubectl get pods -n portainer -o json --request-timeout=10s || true",
    "echo '=== KUBE-SYSTEM POD JSON STATUS ==='",
    "kubectl get pods -n kube-system -o json --request-timeout=10s || true",
    "echo '=== RECENT EVENTS ==='",
    "kubectl get events --all-namespaces --sort-by='.metadata.creationTimestamp' --request-timeout=10s | tail -n 25 || true"
]
