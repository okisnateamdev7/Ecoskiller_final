...
commands = [
    "echo '=== DELETING PODS TO REFRESH CA CERTIFICATES ==='",
    ...
    "kubectl delete pod -n kube-system -l k8s-app=metrics-server || true",
    "kubectl delete pod -n portainer -l app.kubernetes.io/name=portainer || true",
...
print("Sending restart command via SSM...")
cmd_args = [
...
# Poll for execution
print("Waiting for pods restart to complete...")
