...
import 'package:ecoskiller_mobile_app/features/shark_tank/presentation/pages/parent_shark_tank_page.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ParentSharkTankPage(user: user),
          ),
        );
      },
      child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Track your child\'s innovation journey',
                    style: GoogleFonts.inter(color: Colors.white70, fontSize: 12),
                  ),
                ],
              ),
